...
class Modal_factory
  def self.create_modal(parent_presenter, mode)
    modal = nil
    case mode
      when :add_student
        modal = Modal.new("Добавить студента")
